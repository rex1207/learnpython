...
xq_a_token = 'e5b34862efde0714d7fa221899657b4bb9dd76f9'
headers = {'content-type': 'application/json',
           'user-agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.124 Safari/537.36'}


# 抓取雪球自选股清单并导出为xls(可由choice导入)
def get_self_select(access_token=xq_a_token, output=True):
    ...
    # print(df)
    if output:
        df.to_excel("雪球自选股.xlsx", index=False)
    return df
